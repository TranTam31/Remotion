...
class EmotionTest {
    ...
    @Test
    fun addEmotionTest(){
        val date = device.findObject(UiSelector().text("15"))
        date.click()
        Thread.sleep(500)

        var emotion = device.findObject(UiSelector().descriptionContains("Emotion 3"))
        emotion.click()
        Thread.sleep(500)
        ...
        emotion= device.findObject(UiSelector().descriptionContains("Emotion 3"))
        emotion.click()
        Thread.sleep(500)
    ...
    @Test
    fun deleteEmotionTest(){
        val date = device.findObject(UiSelector().descriptionContains("Emotion 3"))
        date.click()
        Thread.sleep(500)
        ...
        val check = device.findObject(UiSelector().text("15"))
